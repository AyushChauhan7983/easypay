...
const Contact = () => {
    ...
    return (
        <>
            <Navbar />
            <div style={{ backgroundColor: "#e4f9fc", minHeight: "110vh", paddingTop: "60px" }}>

                <div class="max-w-5xl max-lg:max-w-3xl mx-auto my-6 font-[sans-serif] mt-16" style={{ backgroundColor: "#e4f9fc" }}>
                    ...
                    <div class="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12" style={{ backgroundColor: "#ffffff" }}>
                        ...
                        <div class="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
                            ...
                            <p class="text-sm text-gray-300 mt-4">Need assistance with your payroll management system or looking for expert help to streamline your payroll processes?</p>
                            ...
                            <ul class="mt-16 space-y-8">
                                <li class="flex items-center">
                                    ...
                                    <a href="/" class="text-white text-sm text-gray-500 ml-4">
                                        easypay@example.com
                                    </a>
                                </li>
                                <li class="flex items-center">
